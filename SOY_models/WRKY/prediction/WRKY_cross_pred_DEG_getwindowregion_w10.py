...
########################################################################
#load model
modelp=load_model('/scrfs/storage/ratnayak/data/DeepLearningLifeSciences/cross_soy_mod/soy_mod/SOY_CNNLSTM_SIGM_W2_mskedfilt_v7_0612.h5')
...
tgdf.to_csv('soy_WRKY_201bp_targets_DEG5999_0612_thres08_windowloc_w10.csv')
