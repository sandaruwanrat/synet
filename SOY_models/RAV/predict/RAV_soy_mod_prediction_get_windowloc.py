...
########################################################################
#load model
modelp=load_model('/scrfs/storage/ratnayak/data/DeepLearningLifeSciences/RAV/ravmod/RAV_SOY_1CNNLSTM_SIGM_full_v5.h5')
...
for seq_record in SeqIO.parse("DEG_DE.2kb_complete.promoters_Nfilt_upper.fa", "fasta"):
...
tgdf.to_csv('RAVSoy_model_targets100w_5999DEG_0518.csv')
