...
########################################################################
#load model
modelp=load_model('/scrfs/storage/ratnayak/data/DeepLearningLifeSciences/RAV/ravmod/RAV_SOY_1CNNLSTM_SIGM_v4.h5')
...
tgdf.to_csv('RAV_Pred_targets100W_predDEG_0430_5999seq.csv')
